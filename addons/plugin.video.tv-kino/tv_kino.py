...
class tv_kino(object):
    ...
    def getStreamUrl(self, channel):
        ...
        @return: string
        """
        url = "rtmp://srv3.stream-server.org:1935/livetv/ app=livetv/ playpath=%s pageURL=http://www.tv-kino.net/stream/live/de/%s.html swfUrl=http://stream.tv-kino.net/player.swf live=true" % (channel.name.lower(), channel.name.lower())
